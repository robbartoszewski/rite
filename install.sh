...
#
#   1. curl -fsSL https://raw.githubusercontent.com/robbartoszewski/rite/v0.5.1/install.sh | sh
#   2. curl -fsSLO https://raw.githubusercontent.com/robbartoszewski/rite/v0.5.1/install.sh
#      shasum -a 256 install.sh     # compare against the release notes
#      sh install.sh
#   3. git clone https://github.com/robbartoszewski/rite.git
#      cd rite && git checkout v0.5.1 && less install.sh && uv tool install .
#

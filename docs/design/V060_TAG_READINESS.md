...
| D6 | **Separation between the two** (§5.4.8) | ✋ manual: processes separated (P2), measured by one session with two Managers' profiles (SPEC §5.4.8), and, as `SPEC.md:2117` says, **not pinned by a test between two Managers**; none exists on `main`. ❌ state is not (P1, P3, P4) | — | the building session's call. The notes must say which properties hold |
